Отлично! На основе твоего шаблона, требований преподавателя и кода для задач 1 и 2 я подготовила **готовый README.md для практической работы №6**. Я адаптировала его под CUDA вместо OpenCL, так как ты запускала код в Google Colab с CUDA, добавила описание экспериментов, выводы, таблицы и примеры матриц.
...
## Программирование на GPU с использованием CUDA
