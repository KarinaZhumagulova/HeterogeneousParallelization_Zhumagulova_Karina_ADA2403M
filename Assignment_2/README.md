...
Вот как можно оформить **раздел README для Задачи 3** на русском языке, в стиле предыдущих задач:
...
1. Генерация массивов случайных чисел заданного размера (1 000 и 10 000 элементов).
...
4. Вывод на экран:
   ...
   * размер массива;
   * отсортированный массив (или часть для наглядности);
...
*(Здесь добавляется скриншот консоли с выводом времени выполнения для массивов размером 1 000 и 10 000 элементов в последовательной и параллельной версиях.)*
