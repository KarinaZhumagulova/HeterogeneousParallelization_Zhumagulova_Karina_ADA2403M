...
### Задание 4 (task4.ipynb / task_4_merge_sort.cu)

**Описание:**
Это задание посвящено реализации **параллельной сортировки слиянием (Merge Sort) на GPU с использованием CUDA**. В нем демонстрируется, как массивы данных можно разделять на подмассивы, сортировать их одновременно на GPU и затем выполнять параллельное слияние, что позволяет ускорить обработку больших массивов.

**Цель задания**

* Реализовать **GPU Merge Sort** с использованием **CUDA**.
* Разделить массив на подмассивы, обрабатываемые отдельными блоками GPU.
* Выполнить **параллельное слияние** отсортированных подмассивов.
* Измерить производительность для массивов размером **10 000 и 100 000 элементов**.
* Проверить корректность сортировки.

**Файлы проекта**

* **task4.ipynb** — Jupyter Notebook для запуска и тестирования алгоритма на GPU с пошаговым объяснением и визуализацией времени выполнения.
* **task_4_merge_sort.cu** — исходный CUDA-код, содержащий реализацию параллельной сортировки слиянием.

**Функционал программы**

1. Генерация массивов случайных чисел заданного размера.
2. Разделение массива на подмассивы, сортируемые отдельными блоками GPU.
3. Параллельное слияние отсортированных подмассивов.
4. Измерение времени выполнения для разных размеров массивов.
5. Проверка корректности сортировки и вывод результата на экран.

**Используемые технологии**

* **C++ / CUDA** — реализация параллельной сортировки на GPU.
* **Jupyter Notebook (.ipynb)** — запуск и тестирование кода в интерактивной среде.
* **std::random** — генерация случайных чисел.
* **cudaEvent_t** — измерение времени выполнения на GPU.
...
### Скриншот результатов
<img width="2314" height="1458" alt="image" src="https://github.com/user-attachments/assets/2b58b69c-4dbd-462a-963a-8bbade059693" />
