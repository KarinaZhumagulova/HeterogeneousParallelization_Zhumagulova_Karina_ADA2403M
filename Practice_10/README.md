...
Отлично! Я подготовлю **полную таблицу Markdown** с твоими результатами для всех массивов и всех вариантов потоков. Для читаемости я оформлю её так:

* Колонки: `Array Size`, `Threads/Block`, `Kernel`, `Sum`, `Mean`, `Variance`, `Time (ms)`
* Каждая строка — отдельный замер.
